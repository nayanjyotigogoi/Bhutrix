      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4">{t("footer.about_text")}</p>
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/bhutrix_/" className="text-muted-foreground hover:text-primary">
        ...
        <div className="mt-12 pt-8 border-t border-muted">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm">
              &copy; {currentYear} Bhutrix. {t("footer.all_rights_reserved")}
            </p>
